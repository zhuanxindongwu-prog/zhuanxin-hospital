...
export const mediaArticles = [
  ...
  },
  {
    ...
    reviewer,
    tags: ['PetVoice', '專心動物醫院', '台日獸醫心臟交流', '犬貓居家生理監測', 'Digital Health'],
    intro:
    ...
    faqs: [
      {
        question: '為什麼專心動物醫院導入 PetVoice？',
        answer:
          '希望補充犬貓兩次回診之間的日常資訊，讓飼主與醫療團隊能從安靜時心率、呼吸、活動與睡眠等長期趨勢討論照護變化。'
      },
      {
        question: '這篇媒體文章和 PetVoice 產品頁有什麼不同？',
        answer:
          '本篇整理導入背景、台日專家交流與媒體報導；PetVoice 產品頁則提供台灣版本、監測項目、購買方式、保固及產品規格。'
      },
      {
        question: '媒體報導代表 PetVoice 可以診斷心臟病嗎？',
        answer:
          '不代表。PetVoice 用於整理居家健康趨勢，不能獨立診斷心臟病或取代心臟超音波、胸腔 X 光與獸醫師評估。'
      }
    ],
    gallery: [
      {
