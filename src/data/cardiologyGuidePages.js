...
const makeGuide = (slug, page) => ({
  ...
  imageCaption: 'AI 輔助繪製｜衛教示意圖，非實際病例或診斷影像。',
  reviewer,
...
const guidePageEntries = [
  ['dog-cough', makeGuide('dog-cough', {
    ...
    image: '/imgs/articles-watercolor/dog-cough.webp',
  ...
  ['breathing-difficulty', makeGuide('breathing-difficulty', {
    ...
    image: '/imgs/articles-watercolor/breathing-difficulty.webp',
  ...
  ['pet-syncope', makeGuide('pet-syncope', {
    ...
    image: '/imgs/articles-watercolor/pet-syncope.webp',
  ...
  ['cat-hindlimb-emergency', makeGuide('cat-hindlimb-emergency', {
    ...
    image: '/imgs/articles-watercolor/cat-hindlimb-emergency.webp',
  ...
  ['cardiac-physical-exam', makeGuide('cardiac-physical-exam', {
    ...
    image: '/imgs/articles-watercolor/cardiac-physical-exam.webp',
  ...
  ['chest-xray', makeGuide('chest-xray', {
    ...
    image: '/imgs/articles-watercolor/chest-xray.webp',
  ...
  ['pet-ecg', makeGuide('pet-ecg', {
    ...
    image: '/imgs/articles-watercolor/pet-ecg.webp',
  ...
  ['nt-probnp', makeGuide('nt-probnp', {
    ...
    image: '/imgs/articles-watercolor/nt-probnp.webp',
  ...
  ['feline-hcm', makeGuide('feline-hcm', {
    ...
    image: '/imgs/articles-watercolor/feline-hcm.webp',
  ...
  ['canine-dcm', makeGuide('canine-dcm', {
    ...
    image: '/imgs/articles-watercolor/canine-dcm.webp',
  ...
  ['canine-heartworm', makeGuide('canine-heartworm', {
    ...
    image: '/imgs/articles-watercolor/canine-heartworm.webp',
  ...
  ['pet-arrhythmia', makeGuide('pet-arrhythmia', {
    ...
    image: '/imgs/articles-watercolor/pet-arrhythmia.webp',
  ...
  ['congenital-heart-disease', makeGuide('congenital-heart-disease', {
    ...
    image: '/imgs/articles-watercolor/congenital-heart-disease.webp',
  ...
  ['pulmonary-hypertension', makeGuide('pulmonary-hypertension', {
    ...
    image: '/imgs/articles-watercolor/pulmonary-hypertension.webp',
  ...
  ['cardiorenal-syndrome', makeGuide('cardiorenal-syndrome', {
    ...
    image: '/imgs/articles-watercolor/cardiorenal-syndrome.webp',
  ...
  ['cardiac-medication', makeGuide('cardiac-medication', {
    ...
    image: '/imgs/articles-watercolor/cardiac-medication.webp',
