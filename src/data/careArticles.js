    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '術前心臟檢查能評估當下狀態，但 TMT 可能在緊迫事件後才急性發生，無法單靠一次正常檢查完全預測。'
        ]
      },
      {
        title: '降低貓咪緊迫並觀察呼吸',
    ...
    sections: [
      {
        title: '噗噗的甲狀腺數值與心臟負擔',
        paragraphs: [
          '噗噗有脫毛與 TT4 偏低，也同時存在腱索斷裂與心臟擴大。由於缺乏其他典型原發性甲狀腺低下症表現，醫療團隊評估後逐步減少並停止甲狀腺素補充。',
      ...
      },
      {
        title: '不要自行開始或停止甲狀腺素',
        paragraphs: [
          '甲狀腺素會影響代謝與心跳，對已有心臟疾病的毛孩尤其需要謹慎。是否使用、調整或停止，都應由獸醫師依完整資料決定。',
