...
export const careArticles = [
  {
    ...
    title: '從診間到家庭：Digital Health 如何重新定義未來動物醫療？',
    description: '專心動物醫院整理 Digital Health、智慧寵物醫療、居家健康監測與台日合作研究如何讓犬貓照護從診間延伸到家庭。',
    image: '/imgs/2026大合照.JPG',
    imageCaption: '專心動物醫院持續投入犬貓心臟專科、居家健康監測與智慧寵物醫療。',
    imageCredit: '圖片來源：專心動物醫院',
    intro: 'Digital Health 正在改變動物醫療的照護方式。透過居家健康監測、連續生理數據與臨床研究，獸醫師能從單次門診檢查延伸到更長期的健康趨勢觀察。',
    highlights: [
      '動物醫療正從疾病治療走向預防醫學與健康管理。',
      'Digital Health 結合居家健康監測、連續生理數據與臨床研究，讓照護從診間延伸到家庭。',
      '專心動物醫院持續推動智慧寵物醫療、台日合作研究與亞洲動物健康資料累積。',
      '未來獸醫醫療將更重視長期健康資料、臨床證據與人工智慧輔助分析，而不是只看單次檢查結果。'
    ],
    sections: [
      {
        title: '什麼是 Digital Health？',
        paragraphs: [
          'Digital Health（數位健康）是近年全球醫療的重要發展方向，透過智慧健康監測、數位科技、遠距照護與臨床研究，讓醫療從「疾病發生後治療」逐漸走向「健康管理、早期辨識與預防醫學」。',
          '在人類醫療中，智慧穿戴裝置已廣泛應用於慢性疾病照護與心血管疾病管理；在動物醫療中，Digital Health 也逐漸成為智慧寵物醫療的重要發展方向。對犬貓而言，它不是取代獸醫師，而是提供更完整、更連續的健康資訊，協助醫療團隊做出更全面的臨床判斷。'
        ]
      },
      {
        title: '為什麼動物需要居家健康監測？',
        paragraphs: [
          '多數犬貓不像人類能主動表達身體不適，也常在疾病初期沒有明顯症狀。傳統醫療主要依靠門診檢查，因此醫師看到的往往只是某一天、某一個時間點的健康狀況。',
          '然而，毛孩大部分時間都在家中生活。居家健康監測能補足門診以外的資訊，透過長期觀察日常變化，讓獸醫師結合病史、理學檢查與其他臨床檢查結果，更完整理解毛孩的健康狀態。'
        ]
      },
      {
        title: '智慧寵物醫療的核心是長期趨勢',
        paragraphs: [
          '智慧寵物醫療並不是單純增加新的科技設備，而是重新思考醫療如何理解健康。一次健康檢查，看見的是一個時間點；長期健康監測，看見的是健康變化的趨勢。',
          '未來的動物醫療，希望從單次診療逐漸延伸到持續健康管理。透過長時間累積的健康資訊，醫療團隊能更早辨識可能的健康變化，並與飼主共同建立更完整的照護策略。'
        ]
      },
      {
        title: '專心動物醫院如何投入智慧寵物醫療？',
        paragraphs: [
          '專心動物醫院長期投入犬貓心臟疾病診療、臨床研究與獸醫教育。近年持續推動智慧健康監測、台日合作研究與預防醫學，希望將居家健康管理逐步整合至臨床照護流程。',
          '洪榮偉院長強調，真正重要的不是資料愈多愈好，而是如何透過臨床研究，找出真正具有醫療意義的健康指標，並轉化為能協助臨床判斷的醫療證據。智慧醫療的目的不是取代獸醫師，而是讓醫療決策建立在更完整、更長期的健康資訊之上。'
        ]
      },
      {
        title: '台日合作研究與亞洲動物健康資料',
        paragraphs: [
          '目前全球許多動物醫療研究主要來自歐美，但亞洲犬貓的品種結構、生活型態、飼養方式與醫療模式，與歐美並不完全相同。',
          '因此，專心動物醫院持續推動台日合作，希望逐步建立更符合亞洲犬貓特性的動物健康資料，支持未來臨床研究、疾病預測與人工智慧輔助醫療發展。建立在地化資料，不只是增加研究數據，更是提升未來醫療品質的重要基礎。'
        ]
      },
      {
        title: '2026 南港寵物展：看見未來動物醫療',
        paragraphs: [
          '2026 年 7 月 3 日至 7 月 6 日，專心動物醫院將於台北南港展覽館一館設立「毛孩心臟健康科技體驗館」，分享智慧寵物醫療、Digital Health、台日合作研究、居家健康監測應用、獸醫師健康講座與毛孩健康諮詢。',
          '專心動物醫院希望讓更多飼主了解，醫療不只是疾病治療，更是每天的健康陪伴。當健康資訊能長期累積，醫療看到的不再只是一次檢查結果，而是一段生命歷程。'
        ]
      }
    ],
    faqs: [
      {
        question: '什麼是智慧寵物醫療？',
        answer: '智慧寵物醫療是結合數位科技、健康監測、臨床研究與獸醫專業，協助提升健康管理、早期風險辨識及醫療決策品質的新型照護模式。'
      },
      {
        question: 'Digital Health 和傳統醫療最大的不同是什麼？',
        answer: 'Digital Health 強調長期健康管理，而不僅依賴單次門診檢查，希望透過連續健康資訊協助醫療團隊更完整理解健康變化。'
      },
      {
        question: 'AI 可以取代獸醫師嗎？',
        answer: '不能。人工智慧可作為資料分析與臨床輔助工具，但醫療診斷與治療仍需由獸醫師結合病史、理學檢查及其他臨床資訊綜合判斷。'
      }
    ]
  },
  {
