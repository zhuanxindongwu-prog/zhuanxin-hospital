export const phoneNumber = '02-2363-3016'
export const phoneHref = 'tel:0223633016'
export const clinicAddress = '台北市中正區東門里仁愛路一段47號1樓'
export const mapsSearchUrl =
  'https://www.google.com/maps/search/?api=1&query=台北市中正區東門里仁愛路一段47號1樓'
